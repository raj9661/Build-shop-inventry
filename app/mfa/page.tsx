...
import { Shield, Smartphone, Loader2, LogOut, CheckCircle2, Copy, ClipboardPaste } from "lucide-react"
            ...
            <div className="space-y-6">
              {mfaStatus === 'SETUP_REQUIRED' && qrCodeUrl && (
                <div className="bg-white p-4 border rounded-xl shadow-sm text-center">
                  ...
                  <p className="text-xs text-gray-400 mt-4 font-mono flex items-center justify-center gap-2 bg-gray-50 p-2 rounded-md">
                    Secret Key: <span className="font-semibold text-gray-700 tracking-wider">{secret}</span>
                    <Button 
                      type="button" 
                      variant="ghost" 
                      size="sm" 
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Button
                      type="button"
                      variant="ghost"
                      className="absolute right-2 top-1/2 -translate-y-1/2 h-10 w-10 p-0 text-gray-500 hover:text-blue-600"
                      onClick={async () => {
                        try {
